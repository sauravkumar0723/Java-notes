...
public class Employee {
	...
	//@Value("#{'raju'}")
//	@Value("#{test.doTest()}")
//	@Value("#{T(com.codeHunt.spring_CodeHunt1.TestStatic).doTestStatic }")
	@Value("#{ test.checkSalary()>500 ? 'valid' : 'Inavalid' }")
	...
	public String toString() {
		return "Employee [eid=" + eid + ", ename=" + ename + ", list=" + list + ", url=" + url + "]";
	}
